...
export class ActivationPage {
  ...
  activationTitle: Locator = this.page.locator('//div[@data-testid="activation-title"]');
  ...
  tosCheckboxLabel: Locator = this.page.locator('//span[@data-testid="tos-checkbox-input"]');
