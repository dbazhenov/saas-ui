...
export class TicketOverview extends CommonPage {
  ...
  // Elements
  ticketOverviewContainer = this.page.locator(
    '//section[@data-testid="ticket-overview-section-container"]',
  );
  departmentName = this.page.locator('//span[@data-testid="department-name"]');
  totalTicketNumber = this.page.locator('//strong[@data-testid="total-ticket-number"]');
  departmentTicketCount = this.page.locator('//strong[@data-testid="department-ticket-count"]');
