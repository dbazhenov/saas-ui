...
context('Dashboard Tests for Free user', () => {
  ...
  it.skip('SAAS-T198 - Verify free account user is not able to get organization tickets', () => {
  ...
  it.skip('SAAS-T225 Verify Free account user is able to view Contacts (static)', () => {
    dashboardPage.methods.waitForDashboardToLoad();
