...
describe('MemberEditModal::', () => {
  ...
  it('should render modal successfully', async () => {
    render(<MemberEditModal member={testMember1} onSubmit={() => {}} onClose={() => {}} isVisible />);
  ...
  it('should call onClose when closing the modal', async () => {
    ...
    render(<MemberEditModal member={testMember1} onSubmit={() => {}} onClose={onClose} isVisible />);

    expect(onClose).toBeCalledTimes(0);
    userEvent.click(await screen.findByTestId('edit-member-cancel-button'));
